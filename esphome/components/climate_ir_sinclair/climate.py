...
climate_ir_lg_ns = cg.esphome_ns.namespace("climate_ir_sinclair")
SinclairIrClimate = climate_ir_lg_ns.class_("SinclairIrClimate", climate_ir.ClimateIR)
...
CONFIG_SCHEMA = climate_ir.CLIMATE_IR_WITH_RECEIVER_SCHEMA.extend(
    {
        cv.GenerateID(): cv.declare_id(SinclairIrClimate),
        cv.Optional(
